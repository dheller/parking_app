...
/* This class listens for updates to the user's GPS.  After the GPS detects
 * a change in location, this class is informed of the change and handles
            ...
            if (isGPSEnabled == false && isNetworkEnabled == false) {
                ...
                if (isNetworkEnabled) {
                    ...
                    if (locationManager != null) {
                        ...
                        //Makes sure the last update isn't more than 2 seconds old
                        if (current - last_update > (1000 * 60 * 2)) {
                            //TODO This still doesn't work as well as it should
